...
import com.example.schopfer.model.Helper;
import com.example.schopfer.model.Recordset;
import com.example.schopfer.model.SqlAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cmdItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent();
                i.setAction("com.example.schopfer.model.ItemMasterSelect");
        ...
        cmdCash.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent();
                i.setAction("com.example.schopfer.model.SalesPaymentCash");
        ...
        cmdCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent();
                i.setAction("com.example.schopfer.model.SalesPaymentCard");
        ...
        cmdWaiter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Sales.this, "Maaf! Masih belum Bisa digunakan",
        ...
        txtNota.setText(mNota);calcTotal();
